...
/**
 * Phase 0은 스펙 구조를 따라 비즈니스 예외를 200 + fail 바디로 돌려준다.
...
public class GlobalExceptionHandler {
	...
	public Response<Void> handleNotAuthenticated(NotAuthenticatedException e) {
		return Response.fail(com.sk.skala.shopapi.tools.Error.NOT_AUTHENTICATED.name());
	}
